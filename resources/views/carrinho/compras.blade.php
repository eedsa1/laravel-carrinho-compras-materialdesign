...
<div class="container">
    <div class="row">
        				...
        				<tr>
                           ...
                           <td class="center">
                               @if($pedido_produto->status == 'PA')
                                <p class="center">
                                    <!-- o "id[]" quer dizer que o campo é um array onde existem vários inputs de mesmo nome. isso faz com que a informação seja enviada para o controller já na forma de array -->
                                    <input type="checkbox" id="item-{{ $pedido_produto->id }}" name="id[]" value="{{ $pedido_produto->id }}"/>

                                    <!-- O fato de ter o id com o texto concatenado com o id do produto facilita pois com isso o usuário pode simplesmente clicar em selecionar para "pegar" o item. Desta forma ele não precisa clicar diretamente no quadradinho do checkbox. -->
        					...
        					<td>{{ number_format($pedido_produto->desconto, 2, ',', '.') }}</td>
        ...
        <div class="row col s12 m12 l12"></div>
        	<div class="divider"></div>
