...
<div class="container">
    ...
    <div class="row">
        ...
        <!-- O forelse teste se a variável é vazia, caso seja exibe a mensagem de erro senão entra no loop -->
        @forelse($pedidos as $pedido)
            <!-- a classe "l" é referente a table, a "s" a mobile e a "m" à desktop. 6 é metado e 12 o total da tela-->
            ...
            <div class="row">
                ...
                <form method="POST" action="{{ route('carrinho.concluir') }}">
                    {{ csrf_field() }}
                    <input type="hidden" name="pedido_id" value="{{ $pedido->id }}">
                    <button type="submit" class="btn-large blue col offset-l1 offset-s1 offset-m1 l5 s5 m5 tooltipped" data-position="top" data-delay="50" data-tooltip="Adquirir os produtos concluindo a compra?">Concluir compra
                    </button>
                </form>
...
<!-- o uso de push força o carregamento do script após o carregamento da página baseado na tag stack no layout já que está é posta ao final do html -->
...
<!-- Método para teste via javascript
